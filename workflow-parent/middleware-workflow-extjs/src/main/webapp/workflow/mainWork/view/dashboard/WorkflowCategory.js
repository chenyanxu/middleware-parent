Ext.define('kalix.workflow.mainWork.view.dashboard.WorkflowCategory', {
  requires: [
    'Ext.view.View',
    'Ext.XTemplate',
    'Ext.scroll.Scroller'
  ...
  createView: function (config) {
    ...
    view.items[0].itemTpl = new Ext.XTemplate(
      ...
      '<div class="readmore iconfont icon-workflow-view" data-qtip="查看" onclick="Ext.create(\'kalix.demo.mainWork.controller.DashboardController\')' +
