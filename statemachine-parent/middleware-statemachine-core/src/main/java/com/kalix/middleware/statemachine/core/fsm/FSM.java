...
**/
package com.kalix.middleware.statemachine.core.fsm;
...
import com.kalix.middleware.statemachine.core.states.FSMTransitionInfo;
import com.kalix.middleware.statemachine.core.states.FSMState;
import com.kalix.middleware.statemachine.core.states.FSMStateAction;
...
public class FSM implements java.io.Serializable {
     ...
     * @return
     */
    public FSMState getCurrentFSMState() { return this._fsm.getCurrentState(); }
