...
public class ClientParams {
    ...
    public static final String OAUTH_SERVER_URL = "http://localhost:8181/authorize"; // 授权地址

    public static final String OAUTH_SERVER_TOKEN_URL = "http://localhost:8181/accessToken"; // ACCESS_TOKEN换取地址
