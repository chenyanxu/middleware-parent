//package com.kalix.middleware.rongcloud.rong.io.rong;
//
...
//		// 获取 Token 方法
//		TokenResult userGetTokenResult = rongCloud.user.getToken("151", "孟佳男", "http://www.rongcloud.cn/images/logo.png");
//		System.out.println("getToken:  " + userGetTokenResult.getToken());
//
////		// 刷新用户信息方法
